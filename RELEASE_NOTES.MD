...
- File explorer performance optimized.
- File explorer scroll bar works again.

## Client 2.4.0

Features

- API keys management UI for user-managed programmatic access by administrators

## Client 2.3.4

Fixes

- Re-enable redirect to moonraker
...
- Queue panel in top bar now updates immediately when queueing prints from Files page

## Client 2.2.7

Features

- Add GCODE file thumbnail support with file-storage backend
- Implement reactive thumbnail viewer dialog
- Add FileThumnailCell component with query optimization

Fixes

- Optimize thumbnail viewer implementation and file naming
- Ensure FileThumnailCell and Viewer use proper query handling

## Client 2.2.6

- Fix progress percentage on dashboard
...
- Job menu added remaining time

Fixes

- Remove profanity from suggested printer names
- Job menu time wasn't formatted as 15m 30s
...
- Designed a printer maintenance log page
