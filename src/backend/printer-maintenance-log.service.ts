...
export class PrinterMaintenanceLogService extends BaseService {
  ...
  static async listLogs(params?: {
    ...
    if (params?.printerId)
      queryParams.append('printerId', params.printerId.toString())
  ...
  static async getActiveByPrinterId(
    printerId: number
  ): Promise<PrinterMaintenanceLog | null> {
  ...
  static async complete(
    ...
    return await this.post<PrinterMaintenanceLog>(
      `${this.baseRoute}/${logId}/complete`,
      data
    )
  }
