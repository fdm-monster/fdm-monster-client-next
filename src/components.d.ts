...
declare module 'vue' {
  export interface GlobalComponents {
    ...
    AlertErrorDialog: typeof import('./components/Generic/Snackbars/AlertErrorDialog.vue')['default']
    ...
    PrinterEmergencyStopAction: typeof import('./components/Generic/Actions/PrinterEmergencyStopAction.vue')['default']
