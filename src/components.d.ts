...
declare module 'vue' {
  export interface GlobalComponents {
    ...
    FileThumbnailCell: typeof import('./components/PrintJobs/FileThumbnailCell.vue')['default']
    FileThumbnailViewer: typeof import('./components/PrintJobs/FileThumbnailViewer.vue')['default']
