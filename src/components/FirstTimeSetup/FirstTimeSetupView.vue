            ...
            <v-stepper-window-item :value="1">
              ...
              >
                ...
                <p class="text-subtitle-1 text-medium-emphasis">
                  Welcome! Let's set up your 3D printing farm management system.
                  <br />
                  ...
                  <div class="setup-option-box pa-8">
                    <div class="text-center mb-8">
                      ...
                      <p class="text-body-2 text-medium-emphasis">
                        Configure your FDM Monster server step by step with the
                        setup wizard.
                      </p>
                    </div>
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        This will skip the wizard and restore your
                        configuration.
                      </div>
                    </div>
                  </div>
                    ...
                    >
                      <div class="text-caption">
                        <v-icon
                          ...
                          class="mr-1"
                          >{{
                            formStep1.loginRequired ? 'check' : 'warning'
                          }}</v-icon
                        >
                        {{
                          formStep1.loginRequired
                            ? 'Login is required for all users.'
                            : 'No login required. Admin role assumed.'
                        }}
                      </div>
                    </v-alert>
                    ...
                    >
                      <div class="text-caption">
                        <v-icon
                          ...
                          >security</v-icon
                        >
                        Server may be publicly exposed. Carefully evaluate
                    ...
                    >
                      <div class="text-caption">
                        <v-icon
                          ...
                          class="mr-1"
                          >{{
                            formStep1.registration ? 'check' : 'block'
                          }}</v-icon
                        >
                        {{
                          formStep1.registration
                            ? 'New accounts can be registered with guest role.'
